...
// ── MODAL (общий для всех страниц с формой) ──
...
(function () {
  ...
  if (!btn) return; // нет бургера на этой странице
  ...
  document.querySelectorAll('.mmenu-trigger').forEach(function (trigger) {
    trigger.addEventListener('click', function () {
      var section = trigger.closest('.mmenu-section');
      var isOpen  = section.classList.contains('is-open');
      document.querySelectorAll('.mmenu-section.is-open').forEach(function (s) {
